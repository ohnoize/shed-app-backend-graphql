...
const resolvers = {
    Mutation: {
        addSubject: (_root, args) => __awaiter(void 0, void 0, void 0, function* () {
            const subject = new subject_js_1.default(Object.assign({}, args));
        ...
        deleteSubject: (_root, args) => __awaiter(void 0, void 0, void 0, function* () { return subject_js_1.default.findOneAndDelete({ name: args.name }); })
    }
};
exports.default = {
    typeDefs,
